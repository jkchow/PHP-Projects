    ...
    <script type="text/javascript">
        ...
        $(function () {			
            grid = $("#maingrid").ligerGrid({
				...
				{ display: '姓名', name: 'content_name', minWidth: 100,align:'center' },
				{ display: '会员手机号', name: 'content_mobile', minWidth: 100,align:'center' },
				{ display: '申请金额', name: 'content_money', minWidth: 100,align:'center' },
                { display: '备注', name: 'content_desc', minWidth: 100,align:'center' },
				{ display: '状态', name: 'content_status', minWidth: 100,type:"enumVars",enumVars:enumVars.agreeVars },
