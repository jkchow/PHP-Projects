...
function deletePoint(){
	...
	//清除允许被清除的覆盖物
	map.clearOverlays();
	window.parent.window.document.getElementById("<?=$_GET["latField"]?>").value="0";
	window.parent.window.document.getElementById("<?=$_GET["lngField"]?>").value="0";
}
...
<br/><br/>
<input type="button" value="删除标点" onclick="deletePoint()"/>
