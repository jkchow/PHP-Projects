    ...
    <script type="text/javascript"> 
        ...
        $(function ()
        {
            ...
            mainform.ligerForm({
				...
				{ display: "昵称", name: "frm[content_name]", newline: true, type: "text",group: "个人资料",groupicon: groupicon},
				
				
				
				{ display: "性别", name: "frm[content_sex]", newline: true, type: "select", comboboxName: "publishSelect", options: { 
