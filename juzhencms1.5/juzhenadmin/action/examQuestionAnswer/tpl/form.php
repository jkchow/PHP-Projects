    ...
    <script type="text/javascript"> 
        ...
        $(function ()
        {
            ...
            mainform.ligerForm({
                ...
                { display: "答案", name: "frm[content_name]", newline: true, type: "text",validate: {required:true,minlength:1}, group: "答案信息", groupicon: groupicon},
				{ display: "分值", name: "frm[content_score]", newline: true, type: "text",validate: {required:true,minlength:1}},
