    ...
    <script type="text/javascript">
        ...
        $(function () {			
            grid = $("#maingrid").ligerGrid({
                ...
                { display: '链接标题', name: 'content_name', minWidth: 100,align:'left' }, 
				{ display: '链接地址', name: 'content_link', minWidth: 100,align:'left'},
				{ display: '发布状态', name: 'publish', width: 100,type:"enumVars",enumVars:enumVars.publishVars },
				{ display: '排序位置', name: 'position', width: 100,align: 'center',
					type: 'int', editor: { type: 'int'}
				},
				
				{ display: '创建人', name: 'create_user', width: 120 },
				...
				url:dataUrl,
				enabledSort:false,clickToEdit: true,enabledEdit: true,
...
<form id="searchForm" onsubmit="f_search();return false">
    ...
    <select name="searchFieldName" style="width:100px;">
        ...
        <option value="content_link">链接地址</option>
    </select>
