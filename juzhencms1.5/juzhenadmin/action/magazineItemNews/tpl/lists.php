...
<head>
    ...
    <script type="text/javascript">
		...
		var magazine_item_id="<?=$_REQUEST["magazine_item_id"]?>";
        var grid = null;
		var dataUrl="?acl="+acl+"&method=listsData&magazine_item_id="+magazine_item_id;
		...
		function add_record(){
			var url="?acl="+acl+"&method=form&magazine_item_id="+magazine_item_id;
			CmsTools.pageJump(url,true);
		}
		function edit_record(recordID){
			if(recordID!=null){
				var url="?acl="+acl+"&method=form&auto_id="+recordID+"&magazine_item_id="+magazine_item_id;
				CmsTools.pageJump(url,true);
			}else{
				...
				if (!rowdata)
					...
					var url="?acl="+acl+"&method=form&auto_id="+rowdata.auto_id+"&magazine_item_id="+magazine_item_id;
					CmsTools.pageJump(url,true);
				}
			}
		}
