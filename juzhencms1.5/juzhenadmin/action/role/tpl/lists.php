...
<head>
    ...
    <script type="text/javascript">
		...
		var grid = null;
		var dataUrl="?acl=role&method=listsData";
        ...
        $(function () {
            ...
            grid = $("#maingrid").ligerGrid({
                checkbox: true,
				columns: [
                //{ display: "ID", name: 'auto_id',width: 120  }, 
                { display: '角色名称', name: 'content_name',align: 'center', minWidth: 120 }, 
...
<form id="searchForm" onsubmit="f_search();return false">
    ...
    <select name="searchFieldName" style="width:100px;">
        <option value="content_name">角色名称</option>
    </select>
