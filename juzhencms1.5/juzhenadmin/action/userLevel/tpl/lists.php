    ...
    <script type="text/javascript">
        ...
        $(function () {	
            grid = $("#maingrid").ligerGrid({
                ...
                { display: '职位名称', name: 'name', minWidth: 100,align:'left' },
		...
		function view_department(){
			location.href="index.php?acl=userDepartment";
		}
...
<form id="searchForm" onsubmit="f_search();return false">
    ...
    <input type="button" value="部门管理" id="btnAdd" class="l-button l-button-submit" onclick="view_department()"/>
