        ...
        $(function ()
        {
            ...
            mainform.ligerForm({
                ...
                { display: "设备号", name: "frm[device_id]", newline: true, type: "text", 
					...
					group: "设备信息", groupicon: groupicon
				}, 
				{ display: "设备类型", name: "frm[app_type]", newline: true, type: "select", comboboxName: "app_typeSelect", options: { 
				data:enumVars.appDeviceTypeVars,
				cancelable: false,
				emptyText:null,
				valueFieldID: "frm[app_type]"
				} },
				{ display: "消息ID", name: "frm[push_id]", newline: true, type: "text"},
				//{ display: "token", name: "frm[token]", newline: true, type: "text"},
				{ display: "所在地址", name: "frm[address]", newline: true, type: "textarea"}, 
