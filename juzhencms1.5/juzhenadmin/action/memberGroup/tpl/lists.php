    ...
    <script type="text/javascript">
        ...
        $(function () {			
            grid = $("#maingrid").ligerGrid({
                ...
                { display: '分组名称', name: 'content_name', minWidth: 100,align:'left' }, 
                /*{ display: '简介', name: 'content_desc', minWidth: 100 },
		...
		function goBack(){
			location.href="?acl=member&method=lists";
		}
...
<form id="searchForm" onsubmit="f_search();return false">
    ...
    <select name="searchFieldName" style="width:100px;">
    	<option value="content_name">分组名称</option>
    </select>
