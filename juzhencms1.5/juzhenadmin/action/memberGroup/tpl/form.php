    ...
    <script type="text/javascript"> 
        ...
        $(function ()
        {
            ...
            mainform.ligerForm({
                ...
                { display: "分组名称", name: "frm[content_name]", newline: true, type: "text", 
					validate: {required:true,minlength:1}, group: "分组信息", groupicon: groupicon
				}, 
				{ display: "简介", name: "frm[content_desc]", newline: true, type: "textarea"},
				//{ display: "返佣比例", name: "frm[reward_percent]", newline: true, type: "text",afterContent: '<div style="margin-right:10px;margin-left:6px;color:red;float:left;">0.01代表订单总金额的1%</div>'},
