...
<head>
    ...
    <script type="text/javascript">
		...
		var job_id="<?=$_REQUEST["job_id"]?>";
        var grid = null;
		var dataUrl="?acl="+acl+"&method=listsData&job_id="+job_id;
        ...
        $(function () {			
            grid = $("#maingrid").ligerGrid({
                ...
                { display: '姓名', name: 'content_name', minWidth: 100,align:'left' },
				{ display: '手机', name: 'content_mobile', minWidth: 100,align:'left' },
				{ display: '邮箱', name: 'content_email', minWidth: 100,align:'left' },
				...
				url:dataUrl,enabledSort:false,clickToEdit: true,enabledEdit: false,
		...
		function add_record(){
			var url="?acl="+acl+"&method=form&job_id="+job_id;
...
<form id="searchForm" onsubmit="f_search();return false">
    ...
    <select name="searchFieldName" style="width:100px;">
        ...
        <option value="content_mobile">手机</option>
