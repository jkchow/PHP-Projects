    ...
    <script type="text/javascript"> 
        ...
        $(function ()
        {
            ...
            mainform.ligerForm({
                ...
                { display: "起始IP", name: "frm[begin_ip]", newline: true, type: "text", 
					validate: {required:true,minlength:1},
					group: "IP禁用", groupicon: groupicon,
					afterContent: '<div style="margin-right:10px;margin-left:6px;color:red;float:left;">请输入IP地址例如:182.92.99.73</div>'
				},
				{ display: "结束IP", name: "frm[end_ip]", newline: true, type: "text", 
					afterContent: '<div style="margin-right:10px;margin-left:6px;color:red;float:left;">若只有单个IP禁用，可与起始IP相同</div>'
				},
                
				{ display: "是否禁用", name: "frm[publish]", newline: true, type: "select", comboboxName: "publishSelect", options: { 
