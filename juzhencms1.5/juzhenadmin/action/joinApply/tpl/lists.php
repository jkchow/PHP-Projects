    ...
    <script type="text/javascript">
        ...
        $(function () {			
            grid = $("#maingrid").ligerGrid({
				...
				{ display: '姓名', name: 'linkman_name', minWidth: 100,align:'center' },
				{ display: '省份', name: 'province_id', minWidth: 100,align:'center' },
				{ display: '城市', name: 'city_id', minWidth: 100,align:'center' },
                { display: '手机', name: 'content_mobile', minWidth: 100 },
...
<form id="searchForm" onsubmit="f_search();return false">
    ...
    <select name="searchFieldName" style="width:100px;">
    	<option value="linkman_name">姓名</option>
