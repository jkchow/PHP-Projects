        ...
        $(function ()
        {
            ...
            mainform.ligerForm({
                ...
                { display: "广告位名称", name: "frm[content_name]", newline: true, type: "text", 
					validate: {required:true,minlength:2}, group: "广告位信息", groupicon: groupicon
				}, 
				{ display: "所在位置", name: "frm[ad_location]", newline: true, type: "select", comboboxName: "locationSelect", options: { 
				data:enumVars.adLocationVars,
				cancelable: false,
				emptyText:null,
				valueFieldID: "frm[ad_location]"
				} },
				...
				{ display: "关联栏目", name: "frm[menu_case]", newline: true, type: "select", comboboxName: "menu_caseSelect", options: { 
				data:enumVars.boolVars,
				cancelable: false,
				emptyText:null,
				valueFieldID: "frm[menu_case]"
				} },
