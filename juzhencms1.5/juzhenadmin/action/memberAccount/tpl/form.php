        ...
        $(function ()
        {
            ...
            mainform.ligerForm({
				...
				{ display: "会员", name: "frm[member_id]", newline: true, type: "select", 
					...
					group: "账户记录", groupicon: groupicon,
				...
				{ display: "金额", name: "frm[content_money]", newline: true, type: "text",validate: {required:true,minlength:1}},
				{ display: "说明", name: "frm[content_desc]", newline: true, type: "text",validate: {required:true,minlength:1}},
				<?
				if($_record["formData"]["auto_id"]!=""){
				?>
				{ display: "账户余额", name: "frm[balance_monay]", newline: true, type: "text",validate: {required:true,minlength:1}},
				<?
				}
				?>
