    ...
    <script type="text/javascript">
        ...
        $(function () {			
            grid = $("#maingrid").ligerGrid({
				...
				{ display: '会员', name: 'member_mobile', width: 120,align:'center' },
				{ display: '说明', name: 'content_desc', minWidth: 100,align:'left' },
                { display: '金额', name: 'content_money', width: 100,align:'center' },
				{ display: '账户余额', name: 'balance_monay', width: 100,align:'center' },
				{ display: '订单', name: 'order_sn', width: 130,align:'center' },
                { display: '创建时间', name: 'create_time', width: 170 }/*,
		...
		function expertExcel(){
			var formData=$("#searchForm").serialize();	
			document.getElementById("download_frame").src="index.php?acl="+acl+"&method=expertExcel&"+formData;
		}
...
<form id="searchForm" onsubmit="f_search();return false">
	...
	<input type="button" value="导出" id="btnExpert" class="l-button l-button-submit" onclick="expertExcel()"/>
    ...
    <select name="searchFieldName" style="width:100px;">
        ...
        <option value="content_desc">原因说明</option>
