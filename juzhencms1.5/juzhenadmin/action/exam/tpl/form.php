        ...
        $(function ()
        {
            ...
            mainform.ligerForm({
                ...
                { display: "标题", name: "frm[content_title]", newline: true, type: "text", 
					validate: {required:true,minlength:5}, group: "问卷信息", groupicon: groupicon
				}, 
				{ display: "简介", name: "frm[content_desc]", newline: true, type: "textarea", validate: {required:true,minlength:6}},
