    ...
    <script type="text/javascript"> 
        ...
        $(function ()
        {
            ...
            mainform.ligerForm({
				...
				{ display: "发信邮箱", name: "frm[from_email]", newline: true, type: "text"},
                { display: "收信邮箱", name: "frm[content_email]", newline: true, type: "text", 
				...
				{ display: "发布成功", name: "frm[content_result]", newline: true, type: "select", comboboxName: "content_resultSelect", options: { 
