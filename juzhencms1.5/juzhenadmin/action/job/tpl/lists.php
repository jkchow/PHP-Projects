    ...
    <script type="text/javascript">
        ...
        $(function () {			
            grid = $("#maingrid").ligerGrid({
				...
				{ display: '职位名称', name: 'content_name', minWidth: 100,align:'left' }, 
				...
				{ display: '操作', isSort: false, width: 180, render: function (rowdata, rowindex, value)
					{
						var h = "";
						h += "<a href='javascript:view_item(" + rowdata.auto_id + ")'>查看简历</a> ";
		...
		function view_item(recordID){
			...
			//跳转到广告列表
			var url="?acl="+menu+".jobApply&method=lists&job_id="+recordID;
