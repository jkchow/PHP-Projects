    ...
    <script type="text/javascript"> 
        ...
        $(function ()
        {
            ...
            mainform.ligerForm({
				...
				{ display: "职位名称", name: "frm[content_name]", newline: true, type: "text", 
					validate: {required:true,minlength:2}
				},
				{ display: "薪金待遇", name: "frm[content_salary]", newline: true, type: "text"},
				{ display: "招聘人数", name: "frm[content_num]", newline: true, type: "text"},
				{ display: "工作地点", name: "frm[work_place]", newline: true, type: "text"},
				{ display: "岗位职责", name: "frm[content_duty]", newline: true, type: "textarea"},
				{ display: "任职要求", name: "frm[content_requirement]", newline: true, type: "textarea"},
