        ...
        $(function ()
        {
            ...
            mainform.ligerForm({
                ...
                { display: "分类名称", name: "frm[content_name]", newline: true, type: "text", 
					validate: {required:true,minlength:1}, group: "栏目信息", groupicon: groupicon
				},
				
				
				{ display: "上级分类", name: "p_code", newline: true, type: "select", comboboxName: "autoCodeSelect", options: { 
				cancelable: true,
				emptyText:"(无)",
				width: 180, 
				selectBoxWidth: 280,
