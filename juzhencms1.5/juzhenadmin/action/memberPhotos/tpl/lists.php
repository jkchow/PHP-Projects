    ...
    <script type="text/javascript">
        ...
        $(function () {			
            grid = $("#maingrid").ligerGrid({
                ...
                { display: '图片地址',isSort: false, minWidth: 400, render: function (rowdata, rowindex, value)
                {
                    var h = "";
					h += "<a href='<?=$global->uploadUrlPath?>" + rowdata.content_img + "' target='_blank'><?=$global->uploadUrlPath?>"+rowdata.content_img+"</a> ";    
                    return h;
                }
                },
				//{ display: '图片链接', name: 'content_name', minWidth: 140,align:'center' }, 
