        ...
        $(function ()
        {
            ...
            mainform.ligerForm({
                ...
                { display: "手机号", name: "frm[content_mobile]", newline: true, type: "text", 
					validate: {required:true,minlength:1}, group: "短信信息", groupicon: groupicon
				},
				{ display: "事件标识", name: "frm[content_type]", newline: true, type: "text"},
				{ display: "短信内容", name: "frm[content_text]", newline: true, type: "textarea"},
				
                
				{ display: "发送成功", name: "frm[content_result]", newline: true, type: "select", comboboxName: "content_resultSelect", options: { 
				data:enumVars.boolVars,
				cancelable: false,
				emptyText:null,
				valueFieldID: "frm[content_result]"
