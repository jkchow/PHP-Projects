    ...
    <script type="text/javascript"> 
        ...
        $(function ()
        {
            ...
            mainform.ligerForm({
                ...
                { display: "结果", name: "frm[content_title]", newline: true, type: "text", 
					validate: {required:true,minlength:1}, group: "测试结果", groupicon: groupicon
				}, 
				{ display: "达到分值", name: "frm[content_score]", newline: true, type: "text", 
					validate: {required:true,minlength:1}
				},
				{ display: "说明", name: "frm[content_desc]", newline: true, type: "textarea", validate: {required:true,minlength:6}}
