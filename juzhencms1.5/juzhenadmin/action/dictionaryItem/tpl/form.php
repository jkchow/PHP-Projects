    ...
    <script type="text/javascript"> 
        ...
        $(function ()
        {
            ...
            mainform.ligerForm({
				...
				{ name: "frm[dictionary_id]", type: "hidden" },
                { display: "标题", name: "frm[content_text]", newline: true, type: "text", 
					validate: {required:true,minlength:1}, group: "变量选项信息", groupicon: groupicon
				}, 
				{ display: "变量值", name: "frm[content_value]", newline: true, type: "text", 
					validate: {required:true,minlength:1}
				},
				{ display: "说明", name: "frm[content_desc]", newline: true, type: "textarea"},
