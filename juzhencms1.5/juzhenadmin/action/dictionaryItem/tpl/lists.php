...
<head>
    ...
    <script type="text/javascript">
		...
		var dictionary_id="<?=$_REQUEST["dictionary_id"]?>";
        var grid = null;
		var dataUrl="?acl="+acl+"&method=listsData&dictionary_id="+dictionary_id;
        ...
        $(function () {			
            grid = $("#maingrid").ligerGrid({
                ...
                { display: '标题', name: 'content_text', minWidth: 100,align:'left' }, 
                { display: '变量值', name: 'content_value', minWidth: 100,align:'center' },
		...
		function add_record(){
			var url="?acl="+acl+"&method=form&dictionary_id="+dictionary_id;
