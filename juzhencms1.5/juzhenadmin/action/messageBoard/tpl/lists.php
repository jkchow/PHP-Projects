    ...
    <script type="text/javascript">
        ...
        $(function () {			
            grid = $("#maingrid").ligerGrid({
				...
				/*{ display: '公司名称', name: 'company_name', minWidth: 100,align:'left' },*/
                { display: '联系人', name: 'content_name', minWidth: 100 },
...
<form id="searchForm" onsubmit="f_search();return false">
    ...
    <select name="searchFieldName" style="width:100px;">
    	<option value="content_title">标题</option>
    	<option value="content_name">联系人</option>
