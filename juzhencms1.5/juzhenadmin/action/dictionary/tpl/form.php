    ...
    <script type="text/javascript"> 
        ...
        $(function ()
        {
            ...
            mainform.ligerForm({
                ...
                { display: "变量名称", name: "frm[content_text]", newline: true, type: "text", 
					validate: {required:true,minlength:2}, group: "变量信息", groupicon: groupicon
				},
				{ display: "变量标识", name: "frm[content_name]", newline: true, type: "text", 
					validate: {required:true,minlength:6}
				},
				{ display: "说明", name: "frm[content_desc]", newline: true, type: "text"},
