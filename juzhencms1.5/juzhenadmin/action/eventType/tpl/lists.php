    ...
    <script type="text/javascript">
        ...
        $(function () {			
            grid = $("#maingrid").ligerGrid({
                ...
                { display: '标识', name: 'event', minWidth: 100 },
				{ display: '启用状态', name: 'publish', minWidth: 100,type:"enumVars",enumVars:enumVars.publishVars },
				{ display: '分类', name: 'type', minWidth: 100,type:"enumVars",enumVars:enumVars.eventTypeVars },
				{ display: '数值', name: 'num', minWidth: 100},
