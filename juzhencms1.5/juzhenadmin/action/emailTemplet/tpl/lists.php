    ...
    <script type="text/javascript">
        ...
        $(function () {			
            grid = $("#maingrid").ligerGrid({
                ...
                { display: '邮件标题', name: 'content_title', minWidth: 100,align:'left' },
                { display: '事件标识', name: 'content_event', width: 100 },
				{ display: '发布状态', name: 'publish', width: 90,type:"enumVars",enumVars:enumVars.publishVars },
				{ display: '排序位置', name: 'position', width: 90 ,align: 'center',
					type: 'int', editor: { type: 'int'}
				},
				{ display: '创建人', name: 'create_user', width: 100 },
...
<form id="searchForm" onsubmit="f_search();return false">
    ...
    <input type="button" value="发送邮件" id="btnSend" class="l-button l-button-submit" onclick="send_record()"/>
    &nbsp;
	发布状态：
    ...
    <select name="searchFieldName" style="width:100px;">
    	<option value="content_title">邮件标题</option>
