        ...
        $(function ()
        {
            ...
            mainform.ligerForm({
				...
				{ display: "选择会员", name: "member_id", newline: true, type: "select", 
					...
					group: "发送邮件", groupicon: groupicon,
					comboboxName: "member_email", options: { 
						width: 250,
						slide: false,
						selectBoxWidth: 505,
						selectBoxHeight: 340,
						valueField: 'auto_id',
						textField: 'content_email',
						grid: {
							columns: [
				...
				{ display: "选择邮件模板", name: "templet_id", newline: true, type: "select", comboboxName: "publishSelect", options: { 
				data:<? $tplList=$dao->get_datalist("select auto_id as id,content_title as text from {$dao->tables->email_templet} "); echo json_encode($tplList); ?>,
				cancelable: false,
				emptyText:null,
