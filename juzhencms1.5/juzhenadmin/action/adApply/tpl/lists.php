    ...
    <script type="text/javascript">
        ...
        $(function () {			
            grid = $("#maingrid").ligerGrid({
                ...
                { display: '申请单位', name: 'company_name', minWidth: 100,align:'left' }, 
				{ display: '负责人姓名', name: 'content_name', minWidth: 100,align:'center' },
                { display: '联系手机', name: 'content_tel', minWidth: 100 },
				{ display: '广告位置', name: 'ad_position', minWidth: 100 },
...
<form id="searchForm" onsubmit="f_search();return false">
    ...
    <select name="searchFieldName" style="width:100px;">
    	...
    	<option value="content_name">负责人姓名</option>
        <option value="content_mobile">联系手机</option>
        <option value="content_tel">联系固话</option>
        <option value="content_email">联系邮箱</option>
        <option value="content_website">公司网址</option>
    </select>
