...
include("../../../global.php");
	...
	$param["paytype_code"]="weixin_qrcode";
	...
	$unifiedOrder->setParameter("attach","weixin_qrcode");//附加数据 
...
<body>
	...
	-->
    <div align="center">
		<a href="<?=$global->siteUrlPath?>/index.php?acl=member&method=orderLists">返回</a>
	</div>
</body>
	...
	<script>
		if(<?php echo $unifiedOrderResult["code_url"] != NULL; ?>)
		{
			...
			wording.innerHTML = "请使用微信扫描下方二维码";
