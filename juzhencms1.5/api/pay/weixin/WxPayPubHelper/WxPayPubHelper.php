...
class Common_util_pub
{
	...
	{		
		...
		/*echo "<pre>";
		echo CURLOPT_TIMEOUT."_".$second."<br/>";
		echo CURLOPT_URL."_".$url."<br/>";
		echo CURLOPT_SSL_VERIFYPEER."_".FALSE."<br/>";
		echo CURLOPT_SSL_VERIFYHOST."_".FALSE."<br/>";
		echo CURLOPT_HEADER."_".FALSE."<br/>";
		echo CURLOPT_RETURNTRANSFER."_".TRUE."<br/>";
		echo CURLOPT_POST."_".TRUE."<br/>";
		echo CURLOPT_POSTFIELDS."_".$xml."<br/>";
		exit;*/
