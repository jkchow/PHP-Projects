...
$(function(){
	...
	$("#resetpwd_form").validate({
		...
		submitHandler:function(form){
			...
			//return;
			var options = {   
				url:       "index.php?acl=member&method=resetPassword",         // override for form's 'action' attribute    
						...
						if(responseText.result){
							...
							$.prompt(responseText.msg, {
								...
								submit: function(e,v,m,f){
									location.href="index.php?acl=member&method=forgetPassword";
								}
							});
...
<div class="pass-cell"><input class="setpass"  type="password" name="content_pass" id="content_pass" placeholder="新密码"/></div>
<div class="pass-cell"><input class="setpass"  type="password" name="confirm_password" id="confirm_password" placeholder="再次输入" /></div>
